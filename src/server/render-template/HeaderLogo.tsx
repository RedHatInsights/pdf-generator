...
const RedHatLogo = () => (
  <svg
    ...
    y="0px"
    viewBox="0 0 613 145"
    style={{ enableBackground: 'new 0 0 613 145' } as React.CSSProperties}
    xmlSpace="preserve"
  >
    <path
      style={{ fill: '#EE0000' }}
      d="M127.5,83.5c12.5,0,30.6-2.6,30.6-17.5c0-1.1-0.1-2.3-0.3-3.4l-7.4-32.4c-1.7-7.1-3.2-10.4-15.7-16.6
...
C190.8,95.1,179.8,80.7,160,72.1"
    />
    <path
      d="M160,72.1c1.7,8.2,1.7,9.1,1.7,10.1c0,14-15.7,21.8-36.4,21.8c-46.8,0-87.7-27.4-87.7-45.5c0-2.5,0.5-5,1.5-7.3l3.7-9.1
c-0.2,0.6-0.2,1.3-0.2,1.9c0,9.2,36.3,39.4,84.9,39.4c12.5,0,30.6-2.6,30.6-17.5c0-1.1-0.1-2.3-0.3-3.4L160,72.1z"
    />
    <path
      style={{ fill: '#000000' }}
      d="M579.7,92.8c0,11.9,7.2,17.7,20.2,17.7c4-0.1,8-0.7,11.9-1.7V95c-2.5,0.8-5.1,1.2-7.7,1.2
